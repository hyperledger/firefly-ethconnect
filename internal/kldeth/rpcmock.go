...
type MockRPCClient struct {
	...
	callError     error
	resultWranger func(string, interface{})
	// Captured results
	SubscribeErr  error
...
func NewMockRPCClientForSync(callErr error, resultWranger func(string, interface{})) *MockRPCClient {
	m := &MockRPCClient{
		callError:     callErr,
